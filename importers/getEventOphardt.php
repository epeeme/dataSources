...
require '../scrapers/ophardtParser/ophardtParser.php';
...
$eventYear = 2019;
$eventURL = "http://fencingworldwide.com/en/competition/16368-2018/tournament/";
// ENDS
...
$resultsBody = stristr(stristr($resultsBody, '<main'), '</main>', true);
...
for ($i=0; $i < count($tableRows); $i++ ) {
    ...
    if ($ageArray[$i] > 0) {
        ...
        $ophardtResultsURL = get_istring_between($tableRows[$i+7], '<a href="', '">');

        $e = new ophardt\OphardtParser("http://fencingworldwide.com".$ophardtResultsURL);
